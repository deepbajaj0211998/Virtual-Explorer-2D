...
public class advance_character_controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(alive==true)
        {
            ...
            // RaycastHit2D hit = Physics2D.Raycast(groundCheckPoint.position, Vector2.down, groundCheckRadius, enemyLayer);
            //     if (hit)
            //         if(hit.transform.tag=="enemy")
            //         {
            //             hit.transform.GetComponent<enemy1>().TakeDamage(100);
            //         }
